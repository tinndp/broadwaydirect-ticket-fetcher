...
/// passed by one attempt during probing (see python/paciolanevenue/docs/EVENUE_PERIMETERX_FINDINGS.md), so a genuinely fresh
...
public sealed class PaciolanEvenueBrowser : IAsyncDisposable
{
    ...
    /// package's live runs (2026-09-21) - see python/paciolanevenue/docs/EVENUE_PERIMETERX_FINDINGS.md. "Please verify you
