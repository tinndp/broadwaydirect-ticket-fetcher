...
/// per request (see dotnet/BroadwayDirect/README.md's "Proxy" section - proxy is set at
...
public sealed class ProxyEnvironmentPool : IAsyncDisposable
{
    ...
    /// see dotnet/BroadwayDirect/README.md for why we don't use an API equivalent to
